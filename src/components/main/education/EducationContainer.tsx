        ...
        <>
            <div className="mb-16 space-y-8">
                ...
                <div className="relative flex justify-center items-center">
                    ...
                    <div className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t dark:from-[#121212] from-[#faf9f4] transition-opacity duration-500 ${isExpanded ? 'opacity-0 h-0' : 'opacity-100 h-20'}`} />
                </div>
                <Button
                    variant="secondary"
                    size="sm"
